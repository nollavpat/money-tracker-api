...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { balance: @wallet.balance, logo_url: @wallet.logo_url, name: @wallet.name } }, as: :json
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { balance: @wallet.balance, logo_url: @wallet.logo_url, name: @wallet.name } }, as: :json
    assert_response :success
  end
